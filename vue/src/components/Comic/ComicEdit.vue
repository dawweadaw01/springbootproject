<template>
    <!-- 动漫修改 -->
	<el-dialog title="编辑动漫" :visible.sync="dialogData.showEditDialog" width="450px" @close="cancelForm">
		<!--
			表单校验
		...
		>
			<el-form-item label="动漫名：" prop="comicName">
				<el-input v-model="model.comicName"></el-input>
			</el-form-item>
